...
let FollowsRepository = class FollowsRepository extends repository_1.DefaultCrudRepository {
    constructor(datasource) {
        super(follows_1.Follows, datasource);
        this.datasource = datasource;
    }
};
FollowsRepository = __decorate([
